...
dataset_root='D:/Data Science/ML Dr Mostafa/03 Deep learning/Projects/Vollyball/Volley dataset files'
...
def create_pkl_version():
    ...
    with open(f'{dataset_root}/annot_all_3frames.pkl', 'wb') as file:
        pickle.dump(videos_annot, file)


def test_pkl_version():
    with open(f'{dataset_root}/annot_all_3frames.pkl', 'rb') as file:
